...
dict1 = {"Chennai Super Kings" :{}, "Deccan Chargers":{},"Delhi Capitals":{},"Delhi Daredevils":{},"Gujarat Lions":{},"Kings XI Punjab":{},"Kochi Tuskers Kerala":{},"Kolkata Knight Riders":{},"Mumbai Indians":{},"Pune Warriors":{},"Rajasthan Royals":{},"Rising Pune Supergiant":{},"Royal Challengers Bangalore":{},"Sunrisers Hyderabad":{}}
team_to_node={"Chennai Super Kings" :0, "Deccan Chargers":1,"Delhi Capitals":2,"Delhi Daredevils":3,"Gujarat Lions":4,"Kings XI Punjab":5,"Kochi Tuskers Kerala":6,"Kolkata Knight Riders":7,"Mumbai Indians":8,"Pune Warriors":9,"Rajasthan Royals":10,"Rising Pune Supergiant":11,"Royal Challengers Bangalore":12,"Sunrisers Hyderabad":13}
set1 = {"Chennai Super Kings"}
team_names= []
for i in range(0,816):
	set1.add(df['team1'][i])
team_names = sorted(set1)
outWorkbook1 = xlsxwriter.Workbook("EDGES_TEAMS_DATA.xlsx")
...
for i in team_names:
	for j in team_names:
		...
		if num_matches!=0:
			dict1[i][j]=1-num_wins_team2/num_matches
...
# outWorkbook = xlsxwriter.Workbook("NODES_TEAMS_DATA.xlsx")
...
page_rank_init={"Chennai Super Kings" :1/14,"Deccan Chargers":1/14,"Delhi Capitals":1/14,"Delhi Daredevils":1/14,"Gujarat Lions":1/14,"Kings XI Punjab":1/14,"Kochi Tuskers Kerala":1/14,"Kolkata Knight Riders":1/14,"Mumbai Indians":1/14,"Pune Warriors":1/14,"Rajasthan Royals":1/14,"Rising Pune Supergiant":1/14,"Royal Challengers Bangalore":1/14,"Sunrisers Hyderabad":1/14}

page_rank_next={"Chennai Super Kings" :1,"Deccan Chargers":1,"Delhi Capitals":1,"Delhi Daredevils":1,"Gujarat Lions":1,"Kings XI Punjab":1,"Kochi Tuskers Kerala":1,"Kolkata Knight Riders":1,"Mumbai Indians":1,"Pune Warriors":1,"Rajasthan Royals":1,"Rising Pune Supergiant":1,"Royal Challengers Bangalore":1,"Sunrisers Hyderabad":1}
